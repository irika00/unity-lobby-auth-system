...
namespace Unity.Services.Multiplayer
{
    ...
    class Matchmaker : ISessionMatchmaking
    {
        ...
        private static MatchmakerModuleOption AddDefaultMatchmakerModuleOption(SessionOptions sessionOptions)
        {
        ...
        static SessionException ConvertException(MatchmakerServiceException exception)
        {
